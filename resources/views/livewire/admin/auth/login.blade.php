<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-lg">
        <img width="377" height="76" src="https://alesnaad.com/wp-content/uploads/2023/11/14-377x76.jpg"
            class="custom-logo" alt="شركة الاسناد الماسي" decoding="async"
            srcset="https://alesnaad.com/wp-content/uploads/2023/11/14-377x76.jpg 377w, https://alesnaad.com/wp-content/uploads/2023/11/14-300x61.jpg 300w, https://alesnaad.com/wp-content/uploads/2023/11/14-768x155.jpg 768w, https://alesnaad.com/wp-content/uploads/2023/11/14.jpg 976w"
            sizes="(max-width: 377px) 100vw, 377px">
        {{-- <h1 class="text-center text-2xl font-bold text-zinc-600 dark:text-slate-200 sm:text-3xl">alesnaad</h1> --}}
            ...
            <div>
                ...
                <div class="relative">
                    <input wire:model='email' type="email"
                        class="w-full rounded-lg border-gray-200 border p-4 pe-12 text-sm shadow-sm"

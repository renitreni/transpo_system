<section class="w-full pb-7">
    ...
    <form wire:submit.prevent='SaveReceipt' class="grid grid-cols-4 mt-14 gap-7">
                ...
                <tbody>
                    ...
                    <tr wire:key='{{ $product['Product'] }}'>
                        ...
                        <td x-data="{expanded: false }">
                            <input
                                ...
                                class="p-1 bg-transparent rounded-md border-black/30 focus:outline-blue-400"></td>
                        ...
                        <td >
                            <input
                                ...
                                wire:model='products.{{ $index }}.WarrantyPeriod'
                                type="number"
                                placeholder="months"
                                min="0"
                        ...
                        <td ><input required wire:model='products.{{ $index }}.WarrantyExpiration' onclick="this.type ='date'" onblur="this.type='text'"   type="text"   class="w-full p-1.5 text-sm bg-transparent rounded-md border-black/30 focus:outline-blue-400"></td>
                        {{-- <td>
                            <div class="relative">
                    ...
                    @empty
                        <tr>
                            ...
                            @else
                                @if (session('no_date'))
                                    <td colspan="12"><span class="text-sm text-rose-500">{{ session('no_date') }}</span></td>
                                @else
        ...
        <div class="flex justify-end gap-3 col-span-full">
            <button type="button" onclick="window.location.href='{{ route('admin_ManageDeliveries',['lang'=>'en']) }}'" class="px-4 py-3 text-white duration-200 rounded-md bg-slate-500 hover:bg-slate-700">Cancel</button>

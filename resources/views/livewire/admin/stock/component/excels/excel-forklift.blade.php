...
<table style="border-collapse: collapse; border-bottom: 1px solid black !important;">
    ...
    <tr>
        ...
        <th style="height:30px;vertical-align:center;font-weight:600;font-size:12px; border-top: 1px solid black; border-bottom: 1px solid black;">Size</th>
        <th style="height:30px;vertical-align:center;font-weight:600;font-size:12px; border-top: 1px solid black; border-bottom: 1px solid black;">Height</th>

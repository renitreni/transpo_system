<div x-show="open" x-transition>
    <form wire:submit='save' class="flex flex-col gap-4">
        <div class="grid grid-cols-4 gap-3">
            ...
            <select class="col-span-2 bg-transparent rounded-md shadow-md cursor-pointer border-black/20 placeholder:text-sm" wire:model='Warehouse'>
            ...
            <div class="col-span-2">
                <select wire:model='Stocks'
                    ...
                    <option selected value="ENSIGN">ENSIGN</option>
                </select>

<form wire:submit='submitApproval' enctype="multipart/form-data" class="container p-5 mx-auto">
    ...
    <div class="grid grid-cols-1 gap-2 p-5 border rounded md:grid-cols-4 border-black/10">
        ...
        <div class="flex flex-col">
            ...
            <input wire:model='DateOfPurchased' class="p-2 border rounded-md shadow border-black/20" type="date">
        </div>
        <div class="flex flex-col">
    ...
    <div class="grid grid-cols-1 gap-2 p-5 mt-5 border rounded md:grid-cols-2 border-black/10">
        ...
        <div class="flex flex-col">
            <label class="text-sm">{{ __('Date') }}</label>
            <input wire:model='SignatureDate' class="p-2 border rounded-md shadow border-black/20" type="date">
        </div>
    </div>
